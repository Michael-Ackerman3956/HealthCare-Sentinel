#!/usr/bin/env python3
"""Generate a second patient dataset with DIFFERENT planted issues.

Creates raw_patients_clinic2 with the same schema as raw_patients but
different data quality problems — tests that the agent can handle novel
data dynamically, not just the issues it's seen before.
"""
...
def main():
    ...
    print(f"\nraw_patients_clinic2: {n} rows created")
